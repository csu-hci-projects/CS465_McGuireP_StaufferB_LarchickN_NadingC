...
In the gaze-only trial, participants used a fixed-duration gaze cursor (set to 1 second) to make selections and check off items. In the controller-only trial, participants used a laser pointer-style beam emitted from the controller to select and interact with list items. Input modality switching was disabled during each trial to preserve experimental control.
