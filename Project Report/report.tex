...
\section{Conclusion}
This study explored the effectiveness of three input modalities: control-based, gaze-based, and gesture-based for the interaction of the task list in a virtual reality environment. Our finding suggest that, while all three modalities are viable, controller-based interaction offers superior performance in terms of speed and accuracy. Gaze-based input provided a more intuitive and hands-free experience, but came at the cost of reduced precision and efficiency. Gesture-based interaction, while promising in concept, was hindered by inconsistent tracking and a higher cognitive load.

These results highlight the trade-offs between traditional and hands-free interaction techniques in XR environments and provide early insight into user preferences and performance in VR-based productivity tools. As extended reality technologies continue to evolve, future work should explore more refined gesture recognition systems, the impact of task complexity, and broader user demographics to better inform design guidelines for immersive task management interfaces.
