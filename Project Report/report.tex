...
%% article.
\begin{abstract}
As extended reality technologies become increasingly integrated into daily life, understanding how users interact with extended reality task management systems in everyday situations is critical. This study explores user interface design in virtual reality by evaluating three different interaction modalities—gaze, gesture, and controller-based—in a VR task list application. A virtual environment was developed in Unreal Engine 5 and tested using the Meta Quest 2, allowing users to test the most flexible modality while interacting with the task list interface and simulating an everyday task like grocery shopping. Findings from our participants suggest that controller-based input offers the fastest and most accurate interaction, while gaze-based interaction provides a more intuitive hands-free experience at the cost of speed and accuracy. Gesture-based interaction was rated the lowest due to tracking inconsistencies and increased cognitive load. These results indicate that while hands-free interaction in VR is feasible, traditional controller-based methods offer superior efficiency in task management. Our findings contribute to the growing body of XR user experience research and suggest design guidelines for future productivity-focused projects in virtual environments.
\end{abstract}
