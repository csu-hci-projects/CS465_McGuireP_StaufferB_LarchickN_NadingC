...
In an increasingly digital world, the integration of augmented reality (AR) into our everyday lives is a promising avenue for promoting productivity and overall user experience. Our project aims to explore this potential by comparing the efficiency of AR interfaces with traditional smartphones list applications across realistic scenarios; potential scenarios ranging from grocery shopping to outdoor activities like fishing or skiing. We will use metrics such as error rate, task completion time, and user satisfaction discovered through user surveys, we aim to further our understanding of whether AR can offer a more intuitive and enjoyable experience for managing routine activities. This project is important in increasing our understanding of AR’s practical applications, but also in guiding the design of future human-computer interaction systems that aim to further bridge the gap between digital and real-world experiences. 
